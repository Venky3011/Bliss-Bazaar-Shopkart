...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.2)">
            <div class="container">
                    <a href="index.php" class="navbar-brand" style="font-family: 'Delius Swash Caps'">Bliss Bazaar Shopkart</a>
                       ...
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   <a href="products.php#Table" class="dropdown-item">Jackets</a>
                                   <a href="products.php#shirt" class="dropdown-item">Womens</a>
                                   <a href="products.php#shoes" class="dropdown-item">Shoes</a>
                                   <a href="products.php#car" class="dropdown-item">Mens</a>
                               </div>
            ...
            <div class="modal-body">
              <form action="signup_script.php" method="post">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md -6">
                        <label for="validation2">User Name</label>
                        <input type="text" class="form-control" id="validation2" name="userName" placeholder="User Name"required>
                    </div>
                </div>
